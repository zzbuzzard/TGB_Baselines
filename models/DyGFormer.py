...
from models.modules import get_time_encoder, TimeEncoder
...
class DyGFormer(nn.Module):
    ...
    def __init__(
        ...
        device: str = "cpu",
        time_encoder: str = "graph_mixer_learnable",
        ...
        self.time_encoder = get_time_encoder(
            time_encoder, out_channels=time_feat_dim, mul=time_multiplier
        )
